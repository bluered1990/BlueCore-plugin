...
public class RankManager {
    ...
    public void updatePlayerRank(Player player) {
        ...
        if (team == null) {
            ...
            team.color(rank.getChatColor());
        }
        
        team.addEntry(player.getName());
        
        // Update player display name
        player.displayName(rank.getFullPrefix().append(player.name().color(rank.getChatColor())));
        player.playerListName(rank.getFullPrefix().append(player.name().color(rank.getChatColor())));
    }
